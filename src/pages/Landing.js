      ...
      <Row>
        <Col>
          ...
          <LandingOption
            ...
            text={"INTERACTIVE CHARACTER SHEET"}
          />
          <LandingOption
            name={"ABOUT"}
            page={"about"}
            method={changePage}
            text={"CREDITS AND OTHER INFO"}
          />
        </Col>
        <img
          className="none992 mright12px"
          src={image}
          alt={"Seek the blessings of the great machine."}
        ></img>
      </Row>
    </div>
  );
